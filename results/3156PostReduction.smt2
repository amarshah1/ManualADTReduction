...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (= l0 l1)) (and (= l0 l0)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 l2)))) )
