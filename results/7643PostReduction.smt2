...
(assert (and (and (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l1 l0)))) )
...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
