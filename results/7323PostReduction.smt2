...
(assert (and (and (and (= l3 l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l0)) (and (= l0 l0)))) )
(assert (and (and (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
