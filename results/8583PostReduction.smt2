...
(assert (and (or (and (= l2 l2)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (or (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)))) )
