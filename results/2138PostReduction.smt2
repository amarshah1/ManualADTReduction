...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l1 l3)) (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)))) )
