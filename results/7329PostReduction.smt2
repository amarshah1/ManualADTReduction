...
(assert (and (or (and (= l0 l0)) (and (= l3 l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l0 l1)) )
(assert (and (or (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
