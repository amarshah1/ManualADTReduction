...
(assert (and (or (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))))) )
