...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l2 l0)) (and (= l1 l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 l2)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l3 l2)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
