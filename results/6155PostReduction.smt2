...
(assert (and (or (and (= l3 l2)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l2 l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l2 l1)) (and (= l3 l3)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l1 Nil) (is-Nil l1)))) )
