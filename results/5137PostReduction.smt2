...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l2 l2)) (and (= l1 l0)))) )
(assert (and (and (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l0 l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l2 l0)) )
