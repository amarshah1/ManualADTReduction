...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)))) )
...
(assert (and (and (and (= l0 l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l2 l1)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
