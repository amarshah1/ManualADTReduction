...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (or (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (= l0 l0))) )
(assert (and (or (and (= l2 l0)) (and (= l1 l1)))) )
