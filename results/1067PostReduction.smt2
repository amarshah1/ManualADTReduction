...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)))) )
...
(assert (and (and (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
