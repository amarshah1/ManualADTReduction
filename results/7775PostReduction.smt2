...
(assert (and (and (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)))) )
(assert (and (not (= l1 l0))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
(assert (and (and (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
