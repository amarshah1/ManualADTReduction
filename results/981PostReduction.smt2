...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l2 l3)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l0 l2))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l0)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l3) (= l3 Nil)))) )
