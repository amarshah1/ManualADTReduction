...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l0 l3)) (and (= l0 l3)))) )
