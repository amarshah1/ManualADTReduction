...
(assert (and (and (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l1 l3)) )
