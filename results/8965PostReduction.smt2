...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)))) )
