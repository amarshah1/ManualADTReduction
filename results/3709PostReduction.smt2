...
(assert (and (= l3 l1)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 l1)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
