...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)))) )
