...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l2 l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 l3)) )
(assert (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
