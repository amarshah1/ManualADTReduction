...
(assert (and (and (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv10 cv11)) (= cv10 (Head l0)) (= cv11 (Tail l0))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv12 cv13)) (= cv12 (Head Nil)) (= cv13 (Tail Nil))) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l2)) (and (is-Nil l3) (= l3 Nil)))) )
