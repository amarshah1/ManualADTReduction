...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)))) )
