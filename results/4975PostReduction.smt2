...
(assert (and (and (and (= l2 l2)) (and (= l3 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))))) )
