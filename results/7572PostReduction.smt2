...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l0 l0)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (= l0 l3)) )
(assert (and (and (and (= l3 l2)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l3 l3)))) )
