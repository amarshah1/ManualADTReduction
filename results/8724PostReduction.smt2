...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (is-Cons l0))) )
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (not (= l3 Nil))) )
(assert (and (not (is-Cons l0))) )
(assert (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv10 cv11)) (= cv10 (Head l2)) (= cv11 (Tail l2))) (and (= l1 l3)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
