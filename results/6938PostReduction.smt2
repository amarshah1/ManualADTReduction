...
(assert (and (or (and (= l3 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv10 cv11)) (= cv10 (Head l1)) (= cv11 (Tail l1))) (and (is-Cons Nil) (= Nil (Cons cv12 cv13)) (= cv12 (Head Nil)) (= cv13 (Tail Nil))))) )
