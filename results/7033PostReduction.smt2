...
(assert (and (= l1 l3)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)))) )
