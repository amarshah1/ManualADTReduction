...
(assert (and (and (and (= l1 l3)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)))) )
