...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l2)))) )
(assert (and (= l1 l1)) )
