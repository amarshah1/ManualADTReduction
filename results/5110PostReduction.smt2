...
(assert (and (= l3 l2)) )
(assert (and (and (and (= l2 l1)) (and (= l1 l3)) (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)))) )
...
(assert (and (or (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)))) )
