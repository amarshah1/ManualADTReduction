...
(assert (and (= l1 l0)) )
(assert (and (= l0 l0)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (= l2 l2)) )
