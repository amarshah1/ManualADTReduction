...
(assert (and (or (and (= l3 l2)) (and (= l0 l3)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l2 l1))) )
(assert (and (and (and (= l3 l0)) (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
