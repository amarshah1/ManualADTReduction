...
(assert (and (or (and (= l2 l1)) (and (= l0 l3)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
