...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 l1)) (and (= l2 l0)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (or (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 l2)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
