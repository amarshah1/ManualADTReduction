...
(assert (and (or (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
(assert (and (or (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
