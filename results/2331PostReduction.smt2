...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (= l1 l1)) (and (= l1 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
