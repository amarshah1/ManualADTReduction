...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) )
(assert (and (not (= l3 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l0 l1)) )
(assert (and (= l1 l0)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
