...
(assert (and (and (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l0 l0))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
