...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)))) )
(assert (and (not (= l3 Nil))) )
