...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)))) )
