...
(assert (and (= l2 l2)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 l0)) )
(assert (and (or (and (= l3 l2)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)))) )
