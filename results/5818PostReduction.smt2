...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l2 l0)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
(assert (and (not (is-Cons l2))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
