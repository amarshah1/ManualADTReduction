...
(assert (and (or (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)))) )
...
(assert (and (= l1 l3)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Nil l3) (= l3 Nil)))) )
