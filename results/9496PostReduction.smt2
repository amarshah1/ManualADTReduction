...
(assert (and (or (and (= l0 l0)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l3 l1)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l1 l1)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
