...
(assert (and (= l3 l1)) )
(assert (and (or (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
