...
(assert (and (or (and (= l2 l1)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
