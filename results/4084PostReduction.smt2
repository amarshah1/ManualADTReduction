...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)))) )
(assert (and (or (and (= l0 l3)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
