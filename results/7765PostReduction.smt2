...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l2)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)) (and (= l3 l3)) (and (= l1 l0)))) )
