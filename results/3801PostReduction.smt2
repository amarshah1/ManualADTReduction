...
(assert (and (= l0 l1)) )
(assert (and (= l1 l1)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l3 l3)) (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)))) )
