...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l3 l3)))) )
(assert (and (= l3 l3)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
