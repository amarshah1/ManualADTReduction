...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)) (and (= l0 l2)) (and (= l1 l0)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l0 l2)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
