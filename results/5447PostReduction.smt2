...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (= l2 l1)))) )
(assert (and (or (and (= l0 l1)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
