...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (is-Cons l0) (= l0 (Cons cv12 cv13)) (= cv12 (Head l0)) (= cv13 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)))) )
