...
(assert (and (and (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Nil l1) (= l1 Nil)))) )
