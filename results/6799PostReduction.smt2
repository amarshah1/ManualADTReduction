...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))))) )
(assert (and (= l2 l1)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv10 cv11)) (= cv10 (Head l3)) (= cv11 (Tail l3))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv12 cv13)) (= cv12 (Head l0)) (= cv13 (Tail l0))) (and (= l0 Nil) (is-Nil l0)))) )
