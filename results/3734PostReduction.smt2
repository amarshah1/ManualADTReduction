...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 l0)))) )
