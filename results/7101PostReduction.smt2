...
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l1 l0)))) )
...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)))) )
