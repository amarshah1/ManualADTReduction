...
(assert (and (and (and (= l0 l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
