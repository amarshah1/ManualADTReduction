...
(assert (and (and (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
