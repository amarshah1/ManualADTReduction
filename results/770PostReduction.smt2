...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))))) )
(assert (and (= l2 l0)) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv12 cv13)) (= cv12 (Head l3)) (= cv13 (Tail l3))) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
