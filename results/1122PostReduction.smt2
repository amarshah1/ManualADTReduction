...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l0 l0)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (= l1 l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
