...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) )
(assert (and (or (and (= l3 l0)) (and (is-Nil l0) (= l0 Nil)))) )
