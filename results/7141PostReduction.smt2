...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)))) )
(assert (and (and (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
