...
(assert (and (and (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
