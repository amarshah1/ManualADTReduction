...
(assert (and (or (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
