...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l3 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) )
(assert (and (and (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)))) )
