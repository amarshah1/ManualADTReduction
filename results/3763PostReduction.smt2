...
(assert (and (or (and (= l1 l1)) (and (= l1 l1)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
(assert (and (= l2 l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l0 l2))) )
(assert (and (or (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
