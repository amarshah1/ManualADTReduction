...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l0)))) )
(assert (and (not (= l1 l1))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
