...
(assert (and (or (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l2 l3)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)))) )
