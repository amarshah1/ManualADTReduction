...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l0 l0)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l3 l0)))) )
