...
(assert (and (or (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
