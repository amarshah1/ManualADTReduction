...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (or (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l0)))) )
