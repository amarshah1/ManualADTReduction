...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l1)) (and (= l1 l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)))) )
