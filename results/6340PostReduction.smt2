...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))))) )
