...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l3 l0)))) )
(assert (and (or (and (= l3 l1)) (and (= l2 l3)) (and (= l1 l0)) (and (= l2 l1)))) )
(assert (and (and (and (= l0 l0)) (and (= l2 l2)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
