...
(assert (and (and (and (= l3 l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
(assert (and (= l3 l3)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
