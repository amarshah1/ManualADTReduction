...
(assert (and (and (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (= l0 l3))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)))) )
