...
(assert (and (and (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 l1)))) )
(assert (and (= l2 l3)) )
...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
