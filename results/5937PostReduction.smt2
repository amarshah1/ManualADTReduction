...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)))) )
...
(assert (and (or (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)))) )
