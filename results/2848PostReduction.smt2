...
(assert (and (= l0 l1)) )
(assert (and (and (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (is-Nil l2))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
