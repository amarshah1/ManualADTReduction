...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l1 l1)) (and (= l0 l3)))) )
