...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (= l3 l1)) (and (= l2 l2)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
