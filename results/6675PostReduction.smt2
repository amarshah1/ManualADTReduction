...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (and (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))))) )
