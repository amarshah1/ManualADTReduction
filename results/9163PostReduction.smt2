...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (= l3 l1)) (and (= l2 l3)))) )
...
(assert (and (or (and (= l1 l0)) (and (= l0 l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
