...
(assert (and (and (and (= l1 l1)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (or (and (= l1 l1)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
