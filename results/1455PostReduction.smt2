...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
(assert (and (and (and (= l0 l0)) (and (= l1 l3)) (and (= l0 l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
