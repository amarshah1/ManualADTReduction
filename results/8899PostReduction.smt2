...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l3 l2)) )
(assert (and (or (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
