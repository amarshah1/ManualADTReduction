...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)) (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l3 l1)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l1 l1)) )
(assert (and (or (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
