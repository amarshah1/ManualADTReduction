...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)))) )
