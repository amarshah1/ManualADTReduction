...
(assert (and (= l2 l1)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Nil l2) (= l2 Nil)))) )
...
(assert (and (or (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)))) )
