...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l2)))) )
(assert (and (and (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l3 l1)) )
