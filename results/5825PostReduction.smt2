...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)))) )
(assert (and (or (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l2 l1))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l1 l1)) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l0 Nil) (is-Nil l0)))) )
