...
(assert (and (and (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
