...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 l3)) )
(assert (and (or (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l2 l0)) )
