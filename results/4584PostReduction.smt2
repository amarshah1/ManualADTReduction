...
(assert (and (not (= l0 Nil))) )
(assert (and (= l0 l2)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l0 l3)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
