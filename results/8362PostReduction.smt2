...
(assert (and (and (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) )
(assert (and (not (= l1 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
