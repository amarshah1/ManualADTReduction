...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (or (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l0 l1)))) )
