...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l0 l1)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)))) )
