...
(assert (and (or (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
