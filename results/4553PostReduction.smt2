...
(assert (and (= l3 l3)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l1 l3)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
