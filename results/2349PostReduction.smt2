...
(assert (and (and (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)))) )
