...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv12 cv13)) (= cv12 (Head l3)) (= cv13 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv14 cv15)) (= cv14 (Head l2)) (= cv15 (Tail l2))))) )
