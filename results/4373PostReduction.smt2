...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l1)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l0 l0)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)))) )
