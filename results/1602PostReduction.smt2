...
(assert (and (and (and (= l3 l1)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)))) )
(assert (and (or (and (= l1 l3)) (and (is-Nil l3) (= l3 Nil)))) )
