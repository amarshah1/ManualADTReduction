...
(assert (and (and (and (= l0 l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
