...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv12 cv13)) (= cv12 (Head l2)) (= cv13 (Tail l2))) (and (= l2 l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv14 cv15)) (= cv14 (Head Nil)) (= cv15 (Tail Nil))))) )
