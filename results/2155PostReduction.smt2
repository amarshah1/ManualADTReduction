...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)))) )
