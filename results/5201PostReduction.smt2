...
(assert (and (and (and (= l3 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)))) )
(assert (and (= l3 l1)) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l1 l0)) )
