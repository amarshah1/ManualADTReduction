...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)))) )
...
(assert (and (or (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)))) )
