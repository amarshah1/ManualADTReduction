...
(assert (and (and (and (= l0 l3)) (and (= l0 l3)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l3)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l1 l2)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (= l1 l2)))) )
