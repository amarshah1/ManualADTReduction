...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
...
(assert (and (or (and (= l0 l0)) (and (= l2 l2)) (and (is-Nil l3) (= l3 Nil)))) )
