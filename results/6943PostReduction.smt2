...
(assert (and (= l0 l2)) )
(assert (and (and (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
