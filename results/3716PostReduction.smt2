...
(assert (and (and (and (= l0 l0)) (and (= l3 l3)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (= l3 l0)) (and (= l3 l2)) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)))) )
