...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l0 l0)) )
(assert (and (and (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 l2)))) )
