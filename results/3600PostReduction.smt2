...
(assert (and (and (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
