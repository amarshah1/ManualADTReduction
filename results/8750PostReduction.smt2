...
(assert (and (or (and (= l2 l3)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l2 l1))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
