...
(assert (and (and (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l3 l2)) )
(assert (and (and (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (or (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l0 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
