...
(assert (and (and (and (= l0 l1)) (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)))) )
...
(assert (and (or (and (= l2 l0)) (and (= l1 l2)))) )
