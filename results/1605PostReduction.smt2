...
(assert (and (or (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 l3)))) )
(assert (and (= l0 l3)) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l2 l3)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (= l3 l2)) )
