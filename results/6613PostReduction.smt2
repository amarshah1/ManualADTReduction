...
(assert (and (or (and (= l3 l2)) (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (or (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (= l0 l0)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
