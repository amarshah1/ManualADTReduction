...
(assert (and (and (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 l0)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
