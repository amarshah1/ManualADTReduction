...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l0 l2)) (and (= l1 l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)))) )
