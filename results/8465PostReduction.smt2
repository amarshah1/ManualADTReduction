...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l0 l3)) (and (is-Nil l3) (= l3 Nil)))) )
