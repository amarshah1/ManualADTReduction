...
(assert (and (or (and (= l3 l3)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
