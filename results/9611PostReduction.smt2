...
(assert (and (and (and (= l1 l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (= l2 l1)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
