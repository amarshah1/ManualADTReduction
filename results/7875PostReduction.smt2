...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)))) )
(assert (and (= l1 l0)) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
