...
(assert (and (or (and (= l3 l3)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)))) )
(assert (and (not (is-Cons l0))) )
(assert (and (not (= l3 l0))) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
