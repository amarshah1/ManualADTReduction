...
(assert (and (or (and (= l2 l1)) (and (= l3 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)))) )
