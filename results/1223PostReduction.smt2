...
(assert (and (or (and (= l0 l1)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l2)))) )
(assert (and (not (= l2 l1))) )
(assert (and (= l1 l2)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
