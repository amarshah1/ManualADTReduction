...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)))) )
