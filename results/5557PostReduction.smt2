...
(assert (and (and (and (= l0 l0)) (and (= l1 l0)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l1 l3)) )
(assert (and (and (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
