...
(assert (and (and (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l3)))) )
(assert (and (not (= l0 l3))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l1)))) )
(assert (and (= l2 l2)) )
(assert (and (= l2 l3)) )
