...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)) (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l0 Nil))) )
