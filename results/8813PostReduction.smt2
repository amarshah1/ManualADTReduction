...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l3 l3)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)))) )
(assert (and (not (= l2 l1))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l3 l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l2 Nil) (is-Nil l2)))) )
