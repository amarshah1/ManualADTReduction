...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l1)) (and (= l1 l3)))) )
...
(assert (and (and (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)))) )
