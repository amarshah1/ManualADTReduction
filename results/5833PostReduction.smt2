...
(assert (and (and (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
