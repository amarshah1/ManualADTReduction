...
(assert (and (and (and (= l0 l1)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
