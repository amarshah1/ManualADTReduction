...
(assert (and (= l0 l2)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Nil l1))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)))) )
(assert (and (and (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)))) )
