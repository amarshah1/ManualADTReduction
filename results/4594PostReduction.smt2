...
(assert (and (or (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l0 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)))) )
