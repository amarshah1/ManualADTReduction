...
(assert (and (and (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
