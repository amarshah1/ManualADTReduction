...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)))) )
(assert (and (or (and (= l1 l3)) (and (= l0 l1)) (and (is-Nil l0) (= l0 Nil)))) )
