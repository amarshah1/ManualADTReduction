...
(assert (and (or (and (= l2 l2)) (and (= l0 l3)))) )
...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l1 l0)) (and (= l1 l1)))) )
