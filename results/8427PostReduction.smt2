...
(assert (and (= l1 l1)) )
(assert (and (and (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l2 l2)) (and (is-Nil l1) (= l1 Nil)))) )
