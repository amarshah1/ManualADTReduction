...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (is-Nil l3))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l2 l3)) (and (= l0 l1)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
