...
(assert (and (or (and (= l3 l1)) (and (= l0 l1)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
