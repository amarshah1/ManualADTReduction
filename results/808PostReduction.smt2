...
(assert (and (or (and (= l2 l1)) (and (= l1 l3)) (and (= l1 l0)))) )
(assert (and (= l1 l0)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
