...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l2 l1)))) )
