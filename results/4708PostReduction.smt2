...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))))) )
(assert (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv10 cv11)) (= cv10 (Head l2)) (= cv11 (Tail l2))) )
(assert (and (or (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)))) )
