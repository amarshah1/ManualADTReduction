...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (is-Nil l0))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
