...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 l2)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l0 l1))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l2 l2)))) )
