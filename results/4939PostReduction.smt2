...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv12 cv13)) (= cv12 (Head Nil)) (= cv13 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv14 cv15)) (= cv14 (Head Nil)) (= cv15 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
