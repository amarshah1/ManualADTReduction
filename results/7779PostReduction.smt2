...
(assert (and (and (and (= l1 l3)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 l2)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))))) )
