...
(assert (and (or (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l0)) (and (= l1 l2)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
