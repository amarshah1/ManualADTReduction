...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l0 l3)) (and (= l1 l1)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
