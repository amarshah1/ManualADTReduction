...
(assert (and (or (and (= l2 l1)) (and (= l3 l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l0)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) )
(assert (and (or (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)))) )
