...
(assert (and (= l3 l0)) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l2 l3)) (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)))) )
(assert (and (and (and (= l0 l2)) (and (is-Nil l0) (= l0 Nil)))) )
