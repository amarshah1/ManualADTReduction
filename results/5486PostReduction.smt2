...
(assert (and (or (and (= l0 l1)) (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)) (and (= l1 l3)))) )
