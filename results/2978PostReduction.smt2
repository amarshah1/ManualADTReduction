...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l1 l3)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l2 l1)) (and (= l2 l0)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
