...
(assert (and (and (and (= l0 l1)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)))) )
(assert (and (= l1 l2)) )
