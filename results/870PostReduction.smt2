...
(assert (and (and (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)))) )
(assert (and (not (is-Nil l1))) )
(assert (and (or (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
