...
(assert (and (or (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l1 Nil) (is-Nil l1)))) )
