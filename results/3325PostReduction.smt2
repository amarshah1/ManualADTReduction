...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (= l3 l2)) (and (= l1 l2)))) )
(assert (and (and (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l0 l1)) )
(assert (and (or (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
(assert (and (or (and (= l2 l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)))) )
