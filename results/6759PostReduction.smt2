...
(assert (and (or (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Nil l3) (= l3 Nil)))) )
