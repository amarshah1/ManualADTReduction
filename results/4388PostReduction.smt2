...
(assert (and (and (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l2 l2)))) )
