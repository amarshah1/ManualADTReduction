...
(assert (and (or (and (= l3 l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 l2)) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l1 l3)))) )
