...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv10 cv11)) (= cv10 (Head l2)) (= cv11 (Tail l2))) (and (= l2 l1)))) )
