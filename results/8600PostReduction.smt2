...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 l0)))) )
(assert (and (or (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
