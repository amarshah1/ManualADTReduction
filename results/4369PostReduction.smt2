...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)))) )
(assert (and (not (= l2 l0))) )
(assert (and (or (and (= l1 l3)) (and (= l1 l2)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
