...
(assert (and (or (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
