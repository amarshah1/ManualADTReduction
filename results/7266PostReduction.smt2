...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l0 Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)))) )
