...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l1)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)))) )
