...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)) (and (= l2 l1)))) )
(assert (and (not (is-Nil l3))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
