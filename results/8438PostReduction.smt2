...
(assert (and (or (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (and (and (= l1 l2)) (and (= l3 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))))) )
