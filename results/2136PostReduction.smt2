...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l1 l2)) (and (= l3 l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (= l3 l2)) )
