...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv12 cv13)) (= cv12 (Head l0)) (= cv13 (Tail l0))) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
