...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l3 l1)))) )
(assert (and (or (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
