...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l0 l2)))) )
(assert (and (and (and (= l2 l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l3 l0))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
