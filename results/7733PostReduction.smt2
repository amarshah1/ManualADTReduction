...
(assert (and (and (and (= l3 l0)) (and (= l1 l0)) (and (= l1 l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
