...
(assert (and (= l1 l2)) )
(assert (and (or (and (= l2 l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 l1)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
