...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l3 l3)))) )
(assert (and (= l1 l0)) )
(assert (and (= l0 l2)) )
(assert (and (and (and (= l3 l3)) (and (= l0 l2)) (and (= l3 l1)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
