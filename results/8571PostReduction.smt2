...
(assert (and (or (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (= l1 l3)) (and (= l3 l0)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)))) )
