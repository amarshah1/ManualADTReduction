...
(assert (and (and (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
