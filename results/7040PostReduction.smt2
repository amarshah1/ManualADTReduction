...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 l1)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l2 l3)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) )
(assert (and (not (= l3 l0))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))))) )
(assert (and (= l1 l1)) )
(assert (and (= l2 l0)) )
(assert (and (and (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)))) )
