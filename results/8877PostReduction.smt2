...
(assert (and (and (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l2 l3)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
