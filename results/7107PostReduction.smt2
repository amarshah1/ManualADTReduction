...
(assert (and (or (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
