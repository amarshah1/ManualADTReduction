...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)) (and (= l0 l3)) (and (is-Nil l0) (= l0 Nil)))) )
