...
(assert (and (and (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l3 l1)) (and (= l1 l2)))) )
(assert (and (= l0 l0)) )
