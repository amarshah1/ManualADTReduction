...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) )
(assert (and (and (and (= l3 l3)) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
