...
(assert (and (and (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l0 l3)) (and (= l0 l1)))) )
