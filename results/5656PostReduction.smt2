...
(assert (and (and (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (not (is-Nil l2))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l3)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
