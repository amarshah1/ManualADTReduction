...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l2 l0)))) )
(assert (and (or (and (= l0 l3)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l3) (= l3 Nil)))) )
