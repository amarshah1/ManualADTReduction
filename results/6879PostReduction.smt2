...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (= l0 l3)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l2)) (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
