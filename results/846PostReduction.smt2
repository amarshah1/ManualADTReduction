...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l0 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l2 l1))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l1 Nil) (is-Nil l1)))) )
