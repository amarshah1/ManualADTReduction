...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l1 l0))) )
(assert (and (not (= l0 l3))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
