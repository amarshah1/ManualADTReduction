...
(assert (and (or (and (= l2 l0)) (and (= l3 l1)))) )
...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 l3)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
(assert (and (and (and (= l0 l3)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)))) )
