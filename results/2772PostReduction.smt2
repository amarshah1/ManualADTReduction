...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil l3) (= l3 Nil)) (and (= l1 l2)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))))) )
