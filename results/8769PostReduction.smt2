...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (is-Nil l3))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l1 l3)) (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)))) )
