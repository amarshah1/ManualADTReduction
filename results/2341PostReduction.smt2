...
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv10 cv11)) (= cv10 (Head l0)) (= cv11 (Tail l0))) (and (= l3 l3)))) )
