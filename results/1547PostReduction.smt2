...
(assert (and (or (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)))) )
(assert (and (or (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
