...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (is-Cons l3) (= l3 (Cons cv12 cv13)) (= cv12 (Head l3)) (= cv13 (Tail l3))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)))) )
