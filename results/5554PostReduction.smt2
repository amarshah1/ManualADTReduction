...
(assert (and (or (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
