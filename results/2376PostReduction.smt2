...
(assert (and (= l1 l1)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
