...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l3 l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (not (is-Nil l1))) )
(assert (and (and (and (= l0 l0)) (and (= l0 l2)) (and (= l3 l0)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (= l2 l3)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)))) )
