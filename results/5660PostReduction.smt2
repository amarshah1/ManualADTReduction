...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 l2)) (and (= l2 l2)) (and (= l1 l2)))) )
(assert (and (or (and (= l1 l3)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l2 l1)) )
