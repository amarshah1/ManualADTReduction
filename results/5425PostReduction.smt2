...
(assert (and (and (and (= l2 l0)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
