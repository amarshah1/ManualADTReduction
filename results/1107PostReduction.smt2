...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l0 l0))) )
(assert (and (or (and (= l2 l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
