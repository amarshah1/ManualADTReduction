...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Nil l3) (= l3 Nil)) (and (= l2 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))) (and (= l0 l3)))) )
