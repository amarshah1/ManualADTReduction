...
(assert (and (and (and (= l1 l1)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
