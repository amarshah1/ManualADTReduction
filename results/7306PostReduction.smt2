...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l3 l3)) )
(assert (and (and (and (= l0 l3)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
