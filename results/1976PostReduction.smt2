...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l1 l2)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l1 l1)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)))) )
