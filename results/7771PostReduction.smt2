...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)))) )
...
(assert (and (or (and (= l0 l1)) (and (= l2 l3)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)))) )
