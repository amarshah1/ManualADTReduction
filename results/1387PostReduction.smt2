...
(assert (and (or (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)))) )
...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
