...
(assert (and (or (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l3 l2))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l3 l1))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
