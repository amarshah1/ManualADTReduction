...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)) (and (= l0 l0)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (= l0 Nil) (is-Nil l0)))) )
