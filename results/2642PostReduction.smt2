...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 l2)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l3)))) )
