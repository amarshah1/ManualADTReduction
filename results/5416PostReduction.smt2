...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)))) )
...
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv10 cv11)) (= cv10 (Head l1)) (= cv11 (Tail l1))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
