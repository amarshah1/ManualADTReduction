...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)) (and (is-Cons l3) (= l3 (Cons cv10 cv11)) (= cv10 (Head l3)) (= cv11 (Tail l3))) (and (= l0 Nil) (is-Nil l0)))) )
