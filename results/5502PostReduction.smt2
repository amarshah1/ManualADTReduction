...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (= l1 Nil))) )
