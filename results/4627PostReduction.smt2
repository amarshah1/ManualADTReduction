...
(assert (and (or (and (= l2 l3)) (and (= l2 l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
