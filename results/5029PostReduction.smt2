...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 l2)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l0)))) )
...
(assert (and (or (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
