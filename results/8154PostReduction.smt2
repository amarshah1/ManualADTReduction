...
(assert (and (= l1 l3)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)))) )
