...
(assert (and (or (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
