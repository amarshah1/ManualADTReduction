...
(assert (and (or (and (= l2 l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (= l0 Nil))) )
(assert (and (not (is-Cons l1))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
