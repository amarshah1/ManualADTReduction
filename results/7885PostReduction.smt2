...
(assert (and (and (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 l3)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)))) )
