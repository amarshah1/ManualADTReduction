...
(assert (and (and (and (= l2 l3)) (and (= l2 l3)))) )
...
(assert (and (= l2 l3)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (or (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
