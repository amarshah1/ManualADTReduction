...
(assert (and (and (and (= l3 l3)) (and (= l2 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l2 l3))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
