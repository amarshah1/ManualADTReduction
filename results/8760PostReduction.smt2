...
(assert (and (or (and (= l1 l1)) (and (= l0 l0)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l2 l3)))) )
