...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)))) )
(assert (and (not (= l0 l0))) )
(assert (and (or (and (= l0 l0)) (and (= l0 l3)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
