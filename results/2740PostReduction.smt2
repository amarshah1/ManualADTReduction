...
(assert (and (= l2 l2)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
