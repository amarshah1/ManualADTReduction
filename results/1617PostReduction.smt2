...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
...
(assert (and (and (and (= l1 l3)) (and (= l3 l1)))) )
