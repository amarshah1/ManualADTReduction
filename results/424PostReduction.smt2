...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (and (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)))) )
