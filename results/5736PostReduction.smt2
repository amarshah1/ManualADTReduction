...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (= l2 l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))))) )
