...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l2) (= l2 Nil)))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l1 l1)) (and (= l1 l3)))) )
