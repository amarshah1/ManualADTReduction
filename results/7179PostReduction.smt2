...
(assert (and (and (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)))) )
