...
(assert (and (or (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (= l3 l1)) (and (= l0 l0)))) )
(assert (and (not (is-Cons Nil))) )
