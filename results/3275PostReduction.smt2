...
(assert (and (or (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
