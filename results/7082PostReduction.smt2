...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l3 l2)) (and (= l1 l1)))) )
