...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l1 Nil))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l1)))) )
