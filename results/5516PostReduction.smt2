...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Cons l0))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l0 l3)) (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
