...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
(assert (and (= l1 l1)) )
(assert (and (= l3 l1)) )
