...
(assert (and (and (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (= l0 l0)) (and (= l0 l0)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
