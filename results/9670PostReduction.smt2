...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (and (and (= l2 l2)) (and (= l2 l1)))) )
