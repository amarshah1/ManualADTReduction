...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)))) )
