...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Nil l2) (= l2 Nil)))) )
