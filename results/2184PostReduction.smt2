...
(assert (and (or (and (= l1 l3)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
