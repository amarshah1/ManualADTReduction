...
(assert (and (and (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)))) )
