...
(assert (and (and (and (= l1 l1)) (and (= l2 l1)) (and (= l2 l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l0)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
