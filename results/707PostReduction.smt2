...
(assert (and (and (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l0 l1)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
