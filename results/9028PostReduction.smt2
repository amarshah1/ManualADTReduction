...
(assert (and (and (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)))) )
(assert (and (or (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
