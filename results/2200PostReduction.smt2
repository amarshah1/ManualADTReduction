...
(assert (and (or (and (= l2 l2)) (and (= l3 l2)) (and (is-Nil l3) (= l3 Nil)))) )
...
(assert (and (or (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)))) )
