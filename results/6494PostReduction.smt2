...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 l1)))) )
(assert (and (or (and (= l2 l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)))) )
