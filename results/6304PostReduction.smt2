...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (not (is-Nil l2))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l0 l1))) )
(assert (and (and (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l2 l2)) (and (= l1 l0)))) )
