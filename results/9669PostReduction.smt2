...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l1 l0)) (and (= l1 l0)) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))))) )
