...
(assert (and (or (and (= l1 l0)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l1 l2)) (and (= l1 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)))) )
