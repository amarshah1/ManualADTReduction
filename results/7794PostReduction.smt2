...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)))) )
