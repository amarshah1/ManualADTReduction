...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l3 l1)) (and (= l3 l1)) (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l3 l1)) )
