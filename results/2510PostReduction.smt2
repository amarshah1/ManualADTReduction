...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons l0))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)))) )
