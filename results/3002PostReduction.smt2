...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)))) )
...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (= l2 l2)) (and (is-Nil l1) (= l1 Nil)))) )
