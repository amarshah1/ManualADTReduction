...
(assert (and (= l0 l1)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (is-Nil l0))) )
(assert (and (not (= l1 l2))) )
(assert (and (and (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l1 l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
