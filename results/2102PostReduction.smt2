...
(assert (and (and (and (= l3 l0)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)))) )
