...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)))) )
