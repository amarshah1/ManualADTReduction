...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv12 cv13)) (= cv12 (Head Nil)) (= cv13 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv14 cv15)) (= cv14 (Head Nil)) (= cv15 (Tail Nil))) (and (= l0 l3)))) )
(assert (and (or (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv16 cv17)) (= cv16 (Head Nil)) (= cv17 (Tail Nil))) )
