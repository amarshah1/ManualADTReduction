...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons l2))) )
(assert (and (= l1 l2)) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
