...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
(assert (and (and (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
