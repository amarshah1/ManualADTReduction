...
(assert (and (and (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons l2))) )
(assert (and (not (= l3 l0))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (= l1 l0)))) )
