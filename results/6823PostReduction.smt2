...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l1)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 l2)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (= l0 l2)) )
