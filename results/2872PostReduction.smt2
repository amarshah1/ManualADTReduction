...
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
...
(assert (and (or (and (= l2 l0)) (and (= l1 l3)) (and (is-Nil l2) (= l2 Nil)))) )
