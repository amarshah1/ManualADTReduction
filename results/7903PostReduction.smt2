...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l0 l0)) (and (= l0 l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
(assert (and (= l0 l0)) )
(assert (and (and (and (= l0 l1)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)))) )
