...
(assert (and (and (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)))) )
