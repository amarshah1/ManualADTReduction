...
(assert (and (or (and (= l1 l0)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l0 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l1 l3)))) )
(assert (and (not (= l3 l2))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
