...
(assert (and (or (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
