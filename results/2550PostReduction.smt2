...
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)))) )
(assert (and (or (and (= l3 l2)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
