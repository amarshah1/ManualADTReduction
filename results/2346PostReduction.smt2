...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l0 l3)) )
(assert (and (or (and (= l3 l3)) (and (= l2 l0)) (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)))) )
