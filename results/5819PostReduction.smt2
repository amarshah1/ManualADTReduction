...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l1)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)))) )
(assert (and (= l0 l3)) )
(assert (and (= l3 l0)) )
(assert (and (= l2 l3)) )
