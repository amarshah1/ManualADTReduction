...
(assert (and (and (and (= l0 l2)) (and (= l2 l1)) (and (= l2 l3)))) )
...
(assert (and (= l2 l1)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
