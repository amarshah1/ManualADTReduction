...
(assert (and (and (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l2)))) )
(assert (and (= l3 l3)) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)))) )
