...
(assert (and (or (and (= l3 l0)) (and (= l3 l3)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l1 l0)) )
(assert (and (= l1 l0)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)))) )
(assert (and (and (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l3)))) )
