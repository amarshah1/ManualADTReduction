...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (= l2 l2)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (= l0 l3)) (and (= l0 l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
