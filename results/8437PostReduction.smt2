...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)))) )
(assert (and (or (and (= l0 l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (or (and (= l0 l0)) (and (= l1 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l0 l0)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)))) )
(assert (and (not (is-Nil l1))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)))) )
