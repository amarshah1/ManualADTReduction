...
(assert (and (and (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (or (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)))) )
