...
(assert (and (and (and (= l2 l0)) (and (= l3 l0)) (and (= l1 l0)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (not (= l2 l0))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 l0)))) )
