...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil l1))) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))))) )
