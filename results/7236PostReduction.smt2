...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 l3)) (and (= l1 l2)))) )
(assert (and (or (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
(assert (and (not (is-Cons l2))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
