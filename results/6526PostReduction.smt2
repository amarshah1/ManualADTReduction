...
(assert (and (or (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
