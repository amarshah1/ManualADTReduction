...
(assert (and (and (and (= l2 l0)) (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Nil l2))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
