...
(assert (and (or (and (= l0 l1)) (and (= l2 l0)))) )
...
(assert (and (or (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
