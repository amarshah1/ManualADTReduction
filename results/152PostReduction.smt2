...
(assert (and (and (and (= l2 l3)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l3 l1)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)))) )
