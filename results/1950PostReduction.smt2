...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 l0)) )
