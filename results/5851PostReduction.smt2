...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l3 Nil))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (= l2 l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
