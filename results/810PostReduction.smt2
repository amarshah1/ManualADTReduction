...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l3 l1)))) )
(assert (and (or (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l1 l0)) )
(assert (and (or (and (= l2 l3)) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
