...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l2 l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (= l1 l3)) )
(assert (and (or (and (= l0 l1)) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
