...
(assert (and (= l2 l1)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)) (and (= l1 l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l2 l0)))) )
