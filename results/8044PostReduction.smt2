...
(assert (and (or (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l2 l2))) )
(assert (and (= l1 l1)) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
