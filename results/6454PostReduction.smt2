...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)))) )
(assert (and (or (and (= l1 l3)) (and (= l0 l3)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
