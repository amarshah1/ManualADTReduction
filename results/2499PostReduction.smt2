...
(assert (and (or (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l3 l0)))) )
