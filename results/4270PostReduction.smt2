...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (= l0 l0)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons Nil))) )
