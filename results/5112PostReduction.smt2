...
(assert (and (and (and (= l2 l0)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (not (= l1 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 l0)) )
