...
(assert (and (and (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l1 l2)) )
(assert (and (= l2 l2)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)))) )
