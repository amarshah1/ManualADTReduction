...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l1 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l3)))) )
