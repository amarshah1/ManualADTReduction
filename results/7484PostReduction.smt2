...
(assert (and (or (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
