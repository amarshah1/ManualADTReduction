...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)))) )
