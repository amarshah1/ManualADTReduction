...
(assert (and (= l1 l0)) )
(assert (and (and (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
