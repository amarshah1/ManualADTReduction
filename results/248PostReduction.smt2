...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 l1)) )
