...
(assert (and (or (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l3 l1))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)) (and (= l2 l3)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
