...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l1 l0)))) )
