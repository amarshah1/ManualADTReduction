...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l3)))) )
