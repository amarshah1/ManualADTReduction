...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l2 l3)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)))) )
