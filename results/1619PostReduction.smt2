...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
(assert (and (is-Cons l1) (= l1 (Cons cv10 cv11)) (= cv10 (Head l1)) (= cv11 (Tail l1))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l3) (= l3 Nil)))) )
