...
(assert (and (or (and (= l3 l1)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
(assert (and (and (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
