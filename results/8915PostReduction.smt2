...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Cons l2))) )
(assert (and (= l0 l2)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
