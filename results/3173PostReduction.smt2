...
(assert (and (= l3 l1)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l2 l1)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
