...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (is-Nil l0) (= l0 Nil)))) )
