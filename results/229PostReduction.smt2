...
(assert (and (and (and (= l3 l3)) (and (= l3 l3)) (and (= l1 l3)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l0 l0)) (and (= l1 l3)) (and (= l2 l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)))) )
