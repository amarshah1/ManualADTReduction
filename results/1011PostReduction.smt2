...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 l0)) )
(assert (and (not (= l3 l2))) )
(assert (and (and (and (= l2 l2)) (and (= l1 l0)))) )
