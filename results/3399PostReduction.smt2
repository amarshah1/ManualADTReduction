...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l0 l1)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (= l2 l1)) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l3 Nil))) )
