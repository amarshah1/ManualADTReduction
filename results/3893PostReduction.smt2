...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l2 l1))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l3 l3)) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
