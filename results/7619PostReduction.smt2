...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l1 l2)))) )
...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (= l2 l0)))) )
