...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l1 l0)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)))) )
