...
(assert (and (and (and (= l3 l3)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l0 l3)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
(assert (and (= l0 l1)) )
