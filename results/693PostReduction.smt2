...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l3 l3)) )
(assert (and (or (and (= l2 l3)) (and (= l3 l1)) (and (= l3 l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
