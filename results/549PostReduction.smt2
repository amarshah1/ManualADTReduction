...
(assert (and (= l1 l2)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
(assert (and (or (and (= l0 l1)) (and (= l3 l1)))) )
(assert (and (or (and (= l1 l0)) (and (= l2 l2)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
