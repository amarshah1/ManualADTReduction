...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)))) )
