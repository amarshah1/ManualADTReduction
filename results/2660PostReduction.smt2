...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l3 l1)) (and (= l0 l2)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
