...
(assert (and (= l1 l0)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)) (and (= l2 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l1 Nil) (is-Nil l1)))) )
