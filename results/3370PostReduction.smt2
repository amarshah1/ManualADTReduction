...
(assert (and (= l0 l3)) )
(assert (and (or (and (= l0 l3)) (and (= l2 l0)))) )
(assert (and (or (and (= l3 l3)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
