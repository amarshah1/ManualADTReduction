...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)))) )
