...
(assert (and (or (and (= l0 l2)) (and (= l0 l3)) (and (= l2 l3)))) )
...
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
