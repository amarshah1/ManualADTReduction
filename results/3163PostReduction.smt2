...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)) (and (= l3 l2)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
