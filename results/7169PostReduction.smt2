...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 l0)) (and (= l0 l0)) (and (= l2 l0)))) )
