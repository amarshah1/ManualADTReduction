...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l0 l3)))) )
(assert (and (not (= l1 l1))) )
(assert (and (and (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l2 l0)) (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)))) )
