...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))) (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) )
(assert (and (and (and (= l2 l3)) (and (is-Cons l2) (= l2 (Cons cv12 cv13)) (= cv12 (Head l2)) (= cv13 (Tail l2))))) )
