...
(assert (and (or (and (= l0 l1)) (and (= l1 l0)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (and (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv10 cv11)) (= cv10 (Head l2)) (= cv11 (Tail l2))) (and (is-Cons l3) (= l3 (Cons cv12 cv13)) (= cv12 (Head l3)) (= cv13 (Tail l3))) (and (= l1 Nil) (is-Nil l1)))) )
