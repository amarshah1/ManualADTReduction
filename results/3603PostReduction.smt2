...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)))) )
(assert (and (or (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
(assert (and (= l3 l2)) )
(assert (and (and (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
