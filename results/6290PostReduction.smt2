...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (= l3 l3)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l3)) (and (= l0 l2)))) )
(assert (and (= l2 l3)) )
(assert (and (and (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
