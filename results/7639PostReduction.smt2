...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l3 l0)) (and (= l2 l3)))) )
(assert (and (and (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (or (and (= l2 l3)) (and (= l2 l3)))) )
