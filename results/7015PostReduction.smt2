...
(assert (and (or (and (= l2 l1)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
