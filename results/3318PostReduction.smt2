...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))) (and (= l2 l3)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
