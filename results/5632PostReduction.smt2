...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l2 l0)))) )
