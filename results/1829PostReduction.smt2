...
(assert (and (and (and (= l1 l2)) (and (= l3 l1)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l3 l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)))) )
