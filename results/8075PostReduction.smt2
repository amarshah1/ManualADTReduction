...
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l1 l2)))) )
