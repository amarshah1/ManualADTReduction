...
(assert (and (not (= l0 l1))) )
(assert (and (or (and (= l0 l3)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
