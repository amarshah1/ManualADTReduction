...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l0) (= l0 (Cons cv10 cv11)) (= cv10 (Head l0)) (= cv11 (Tail l0))) (and (= l0 l1)))) )
