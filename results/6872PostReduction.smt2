...
(assert (and (or (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (and (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)))) )
