...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
...
(assert (and (or (and (= l0 l1)) (and (= l1 l1)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l3 Nil) (is-Nil l3)))) )
