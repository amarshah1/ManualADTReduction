...
(assert (and (or (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l2)) (and (= l1 l3)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)))) )
