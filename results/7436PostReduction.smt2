...
(assert (and (and (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) )
(assert (and (= l0 l0)) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
