...
(assert (and (= l1 l1)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (= l3 l1))) )
(assert (and (or (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)))) )
(assert (and (= l1 l2)) )
