...
(assert (and (or (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l1 l0)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l1 l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)))) )
