...
(assert (and (and (and (= l3 l0)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l1 l3))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)))) )
(assert (and (or (and (= l0 l2)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))))) )
