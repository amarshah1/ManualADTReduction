...
(assert (and (and (and (= l1 l0)) (and (= l3 l3)) (and (= l2 l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))))) )
(assert (and (= l1 l1)) )
