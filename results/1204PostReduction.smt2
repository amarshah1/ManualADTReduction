...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))))) )
