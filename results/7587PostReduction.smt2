...
(assert (and (and (and (= l0 l0)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 l0)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
