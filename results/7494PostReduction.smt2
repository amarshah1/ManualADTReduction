...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)))) )
(assert (and (or (and (= l3 l1)) (and (= l3 l0)))) )
...
(assert (and (or (and (= l2 l0)) (and (= l1 l0)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
