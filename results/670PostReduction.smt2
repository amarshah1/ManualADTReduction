...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l2 l0)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (= l0 Nil) (is-Nil l0)))) )
