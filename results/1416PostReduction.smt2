...
(assert (and (or (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)))) )
(assert (and (or (and (= l0 l1)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 l0)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 l2)))) )
