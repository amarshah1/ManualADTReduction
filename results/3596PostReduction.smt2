...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (not (= l1 Nil))) )
