...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l0 l1))) )
(assert (and (not (is-Nil l1))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l3)) (and (= l3 l3)) (and (= l2 l3)))) )
