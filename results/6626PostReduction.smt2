...
(assert (and (or (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)))) )
(assert (and (or (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)))) )
...
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
