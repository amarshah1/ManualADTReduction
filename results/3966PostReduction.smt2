...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l1)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l0 l1)) (and (= l2 l3)))) )
(assert (and (and (and (= l3 l1)) (and (= l1 l0)))) )
