...
(assert (and (or (and (= l3 l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 l1)) (and (= l1 l1)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (= l0 l0)) )
