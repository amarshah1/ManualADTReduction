...
(assert (and (and (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)))) )
