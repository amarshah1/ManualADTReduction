...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l1 l3)) )
(assert (and (and (and (= l2 l1)) (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
