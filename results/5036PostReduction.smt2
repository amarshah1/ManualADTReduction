...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)))) )
(assert (and (or (and (= l3 l1)) (and (is-Nil l2) (= l2 Nil)))) )
