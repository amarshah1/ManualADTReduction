...
(assert (and (and (and (= l1 l2)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (= l0 l2)) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)))) )
