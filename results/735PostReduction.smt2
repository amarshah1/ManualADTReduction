...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l0 l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l2 l2)))) )
(assert (and (and (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 l0)) (and (= l0 l1)))) )
