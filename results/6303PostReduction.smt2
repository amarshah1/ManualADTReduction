...
(assert (and (and (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l3 l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)))) )
