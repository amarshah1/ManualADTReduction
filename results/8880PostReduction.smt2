...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l1 l1)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l3 l0)) (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)))) )
