...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)) (and (= l3 l3)))) )
(assert (and (= l0 l1)) )
...
(assert (and (and (and (= l1 l0)) (and (= l0 l1)))) )
(assert (and (= l1 l0)) )
