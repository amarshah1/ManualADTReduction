...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l3)))) )
