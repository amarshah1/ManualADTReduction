...
(assert (and (and (and (= l2 l2)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)))) )
