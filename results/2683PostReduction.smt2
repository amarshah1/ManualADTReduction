...
(assert (and (or (and (= l1 l2)) (and (= l2 l2)) (and (= l1 l2)))) )
(assert (and (not (= l3 l0))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 l2)) )
(assert (and (and (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)))) )
