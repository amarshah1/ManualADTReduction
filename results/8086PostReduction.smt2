...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (= l1 l2)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)))) )
