...
(assert (and (or (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l0 l3)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
