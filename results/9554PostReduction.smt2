...
(assert (and (and (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)))) )
(assert (and (or (and (= l2 l2)) (and (= l0 l0)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
