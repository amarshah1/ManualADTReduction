...
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 l0)))) )
