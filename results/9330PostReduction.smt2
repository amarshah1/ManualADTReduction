...
(assert (and (or (and (= l3 l0)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (not (= l3 Nil))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (= l0 l0)))) )
