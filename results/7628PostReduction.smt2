...
(assert (and (and (and (= l3 l1)) (and (= l2 l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)))) )
