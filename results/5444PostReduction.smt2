...
(assert (and (or (and (= l3 l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)))) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l2 l1)))) )
