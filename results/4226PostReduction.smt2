...
(assert (and (= l0 l3)) )
(assert (and (and (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)) (and (= l3 l0)))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l0)))) )
