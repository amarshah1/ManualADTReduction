...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (is-Nil l0) (= l0 Nil)))) )
