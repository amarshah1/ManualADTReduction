...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
(assert (and (not (= l1 l2))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)))) )
(assert (and (or (and (= l1 l1)) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (= l3 l3)) )
