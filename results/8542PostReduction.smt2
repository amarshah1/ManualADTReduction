...
(assert (and (and (and (= l1 l1)) (and (= l3 l3)) (and (= l0 l1)))) )
(assert (and (not (= l3 l2))) )
(assert (and (and (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
