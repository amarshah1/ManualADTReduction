...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l0 l0)))) )
(assert (and (not (= l1 l0))) )
(assert (and (or (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 l0)) )
(assert (and (= l0 l0)) )
(assert (and (= l1 l3)) )
