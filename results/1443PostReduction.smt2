...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
(assert (and (= l3 l2)) )
(assert (and (= l3 l3)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (or (and (= l2 l0)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)))) )
