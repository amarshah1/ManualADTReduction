...
(assert (and (and (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l3 l1)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (= l3 l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l3 l2)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)))) )
