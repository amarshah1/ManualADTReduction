...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l2 l3)))) )
(assert (and (and (and (= l1 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
