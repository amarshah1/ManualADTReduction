...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)))) )
...
(assert (and (or (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 l0)))) )
