...
(assert (and (and (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)))) )
(assert (and (= l0 l2)) )
