...
(assert (and (and (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
(assert (and (= l3 l3)) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
