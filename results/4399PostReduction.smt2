...
(assert (and (= l1 l2)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (= l0 l3)))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)))) )
