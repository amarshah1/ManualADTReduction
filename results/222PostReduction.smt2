...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l0 l1)) (and (= l2 l0)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
