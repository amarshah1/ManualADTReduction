...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (= l3 l2)) (and (is-Nil l1) (= l1 Nil)))) )
