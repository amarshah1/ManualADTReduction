...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 l0)) )
(assert (and (and (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)))) )
