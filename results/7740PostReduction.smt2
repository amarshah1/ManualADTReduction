...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l0 l2)) (and (= l2 l3)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l1)) (and (= l2 l0)))) )
(assert (and (= l0 l0)) )
