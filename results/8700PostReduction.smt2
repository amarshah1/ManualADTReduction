...
(assert (and (or (and (= l1 l3)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l3 l0)) (and (= l3 l3)) (and (= l3 l2)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l3 l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
