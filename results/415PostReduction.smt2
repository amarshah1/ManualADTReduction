...
(assert (and (or (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l0 l1)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l0 l3)))) )
