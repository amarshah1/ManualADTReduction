...
(assert (and (or (and (= l1 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))))) )
