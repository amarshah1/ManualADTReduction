...
(assert (and (and (and (= l0 l2)) (and (= l0 l0)) (and (= l0 l0)) (and (= l1 l1)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (and (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
