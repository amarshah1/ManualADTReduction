...
(assert (and (and (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 l3)) )
