...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)))) )
(assert (and (and (and (= l2 l3)) (and (= l0 l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
