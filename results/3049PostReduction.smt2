...
(assert (and (and (and (= l2 l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)))) )
