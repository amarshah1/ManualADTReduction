...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l0 l0)) (and (= l1 l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l3)))) )
(assert (and (= l0 l3)) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
