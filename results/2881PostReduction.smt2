...
(assert (and (or (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (is-Cons Nil))) )
