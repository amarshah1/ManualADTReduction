...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l0 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 Nil) (is-Nil l0)))) )
