...
(assert (and (and (and (= l1 l2)) (and (= l2 l3)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l1 l0))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l2)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l3 l3)))) )
