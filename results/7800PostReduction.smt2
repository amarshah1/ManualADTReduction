...
(assert (and (and (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
