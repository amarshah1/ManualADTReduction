...
(assert (and (= l3 l0)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) )
(assert (and (not (= l1 l1))) )
(assert (and (and (and (= l0 l1)) (and (= l2 l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
