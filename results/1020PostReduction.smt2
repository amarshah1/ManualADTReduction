...
(assert (and (= l3 l0)) )
(assert (and (and (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)))) )
(assert (and (= l3 l0)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
