...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 l2)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (= l0 l0)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)))) )
