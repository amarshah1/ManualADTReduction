...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)))) )
