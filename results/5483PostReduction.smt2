...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 l0)) )
(assert (and (= l1 l0)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l0 l2)))) )
