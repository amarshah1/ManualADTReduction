...
(assert (and (and (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l3)) (and (= l1 l1)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))))) )
