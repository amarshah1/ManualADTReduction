...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)))) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (is-Nil l2) (= l2 Nil)))) )
