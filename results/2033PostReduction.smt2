...
(assert (and (or (and (= l1 l0)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (= l1 l0))) )
(assert (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
