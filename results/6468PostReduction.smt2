...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)))) )
