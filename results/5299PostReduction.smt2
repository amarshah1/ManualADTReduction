...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l3 l1))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
