...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l1 l2)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l3 Nil))) )
