...
(assert (and (= l0 l2)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l0 l3))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
