...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l3)))) )
(assert (and (= l0 l3)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
