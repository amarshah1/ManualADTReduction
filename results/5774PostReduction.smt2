...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l0)) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 l1)) )
