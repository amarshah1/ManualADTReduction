...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l3 l3)))) )
