...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l1 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l3 l2))) )
(assert (and (and (and (= l3 l3)) (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l3 l3)) )
