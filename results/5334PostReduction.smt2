...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l1)) (and (= l2 l3)) (and (= l1 l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)))) )
