...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)))) )
