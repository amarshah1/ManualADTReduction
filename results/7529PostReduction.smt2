...
(assert (and (or (and (= l2 l1)) (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 l3)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l0 l0)) (and (= l3 l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
