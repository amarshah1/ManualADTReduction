...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l1 l3)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (and (and (= l2 l1)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
