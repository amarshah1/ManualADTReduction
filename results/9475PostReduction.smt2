...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (= l1 l3)))) )
