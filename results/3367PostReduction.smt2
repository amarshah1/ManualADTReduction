...
(assert (and (= l0 l2)) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l2) (= l2 Nil)))) )
