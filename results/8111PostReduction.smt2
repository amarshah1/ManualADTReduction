...
(assert (and (and (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l2 l3)) )
(assert (and (not (= l0 l0))) )
(assert (and (or (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
