...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) )
(assert (and (not (is-Nil l0))) )
(assert (and (or (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)))) )
