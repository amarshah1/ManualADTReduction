...
(assert (and (and (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l1)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l1) (= l1 Nil)))) )
