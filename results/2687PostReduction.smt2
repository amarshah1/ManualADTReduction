...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l0 l0)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
