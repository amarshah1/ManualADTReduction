...
(assert (and (or (and (= l2 l1)) (and (= l3 l2)) (and (= l0 l0)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)))) )
