...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 l1)) (and (= l1 l2)))) )
(assert (and (= l2 l3)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
