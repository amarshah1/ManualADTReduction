...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)))) )
