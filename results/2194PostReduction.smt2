...
(assert (and (and (and (= l1 l3)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
