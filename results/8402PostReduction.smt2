...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)))) )
...
(assert (and (and (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))))) )
