...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l2 l1)))) )
(assert (and (or (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)))) )
...
(assert (and (or (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
