...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l1 l2)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) )
(assert (and (or (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (= l0 l1)) (and (= l0 l1)) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)))) )
