...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l3)) (and (= l0 l1)) (and (= l2 l2)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)))) )
