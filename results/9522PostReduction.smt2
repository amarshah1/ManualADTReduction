...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Cons l3))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 l2))) )
(assert (and (or (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
