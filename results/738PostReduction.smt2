...
(assert (and (or (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (= l2 l3)) (and (= l2 l0)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
