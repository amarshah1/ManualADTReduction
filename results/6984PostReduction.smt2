...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (= l2 l1)))) )
