...
(assert (and (= l2 l2)) )
(assert (and (or (and (= l0 l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 l3)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l3 l3)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)))) )
