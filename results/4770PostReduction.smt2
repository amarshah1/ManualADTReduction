...
(assert (and (and (and (= l1 l1)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)))) )
