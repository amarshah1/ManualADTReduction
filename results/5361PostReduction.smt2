...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 l0)) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))))) )
(assert (and (or (and (= l0 l3)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
