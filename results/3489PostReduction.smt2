...
(assert (and (or (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l1 l0)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l3 l3)) (and (= l3 l1)) (and (= l2 l0)))) )
(assert (and (or (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)) (and (= l2 l0)))) )
