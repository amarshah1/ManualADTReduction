...
(assert (and (= l1 l0)) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l2 l2)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)))) )
...
(assert (and (or (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
