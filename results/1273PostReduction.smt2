...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))))) )
(assert (and (and (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)))) )
(assert (and (or (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)) (and (= l2 l1)))) )
(assert (and (= l1 l0)) )
