...
(assert (and (and (and (= l3 l3)) (and (= l0 l3)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
