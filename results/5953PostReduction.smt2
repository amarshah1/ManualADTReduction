...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)))) )
...
(assert (and (or (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))))) )
(assert (and (and (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)))) )
