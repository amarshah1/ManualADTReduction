...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l2 l0))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
