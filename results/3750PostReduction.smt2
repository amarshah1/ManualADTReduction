...
(assert (and (or (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
