...
(assert (and (and (and (= l1 l3)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
