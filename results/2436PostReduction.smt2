...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 l0)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (not (is-Cons l0))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (= l1 l0)))) )
