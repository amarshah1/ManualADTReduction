...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (= l3 l3)) (and (= l2 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l3 l1)) (and (= l2 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
