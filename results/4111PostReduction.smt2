...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l0 l3)) (and (= l2 l0)))) )
(assert (and (= l0 l1)) )
