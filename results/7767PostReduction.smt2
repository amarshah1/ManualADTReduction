...
(assert (and (and (and (= l3 l1)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l2 l0)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l2 l2)) (and (= l3 l1)))) )
