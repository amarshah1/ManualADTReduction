...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)))) )
(assert (and (= l0 l1)) )
(assert (and (= l0 l3)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l0 l1)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
