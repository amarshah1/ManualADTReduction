...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l0)))) )
(assert (and (and (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
