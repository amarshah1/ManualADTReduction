...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
(assert (and (= l1 l0)) )
(assert (and (not (is-Cons l1))) )
(assert (and (and (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
