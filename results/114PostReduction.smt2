...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)))) )
