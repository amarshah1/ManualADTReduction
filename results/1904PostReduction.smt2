...
(assert (and (or (and (= l3 l3)) (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l2 l2)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
