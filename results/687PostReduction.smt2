...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)))) )
