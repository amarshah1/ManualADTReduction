...
(assert (and (and (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (or (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l1 l1)))) )
(assert (and (= l3 l3)) )
