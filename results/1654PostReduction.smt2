...
(assert (and (and (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 l2)) (and (= l3 l1)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
