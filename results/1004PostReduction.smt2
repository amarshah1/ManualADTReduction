...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons l1))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)))) )
