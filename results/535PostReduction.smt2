...
(assert (and (= l3 l3)) )
(assert (and (and (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)))) )
