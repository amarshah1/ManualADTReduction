...
(assert (and (and (and (= l1 l0)) (and (= l2 l3)) (and (= l1 l3)))) )
(assert (and (or (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l3 l1)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)))) )
