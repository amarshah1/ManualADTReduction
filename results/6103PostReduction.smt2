...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l2 l0)) )
(assert (and (= l2 l1)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)))) )
(assert (and (= l3 l2)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)) (and (is-Nil l0) (= l0 Nil)))) )
