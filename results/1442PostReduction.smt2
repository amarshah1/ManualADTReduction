...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l3 l2)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)))) )
