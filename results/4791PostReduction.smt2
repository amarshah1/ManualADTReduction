...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
(assert (and (and (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l2 l1)) (and (= l2 l0)) (and (= l0 l1)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
