...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)))) )
(assert (and (and (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (and (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (is-Cons l3))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l3 l3)))) )
