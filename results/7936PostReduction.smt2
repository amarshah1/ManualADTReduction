...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (= l2 l1)))) )
