...
(assert (and (and (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)))) )
