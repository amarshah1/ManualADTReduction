...
(assert (and (or (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))))) )
