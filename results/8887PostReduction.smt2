...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l0 l1)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
