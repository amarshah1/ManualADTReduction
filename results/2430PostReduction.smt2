...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (not (is-Nil l1))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))))) )
(assert (and (= l0 l2)) )
