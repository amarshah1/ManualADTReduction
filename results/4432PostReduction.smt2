...
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (not (= l0 l0))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
