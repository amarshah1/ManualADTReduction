...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l1 l1))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
