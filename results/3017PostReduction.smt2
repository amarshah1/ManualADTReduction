...
(assert (and (or (and (= l0 l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l1)))) )
(assert (and (or (and (= l3 l3)) (and (= l3 l0)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l0 l1)) (and (= l3 l3)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)))) )
