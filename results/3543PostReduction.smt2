...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)) (and (= l3 l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 l1)))) )
