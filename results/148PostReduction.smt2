...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))))) )
(assert (and (= l1 l3)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
