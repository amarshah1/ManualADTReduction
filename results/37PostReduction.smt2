...
(assert (and (or (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
...
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l3 l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l2 Nil) (is-Nil l2)))) )
