...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
...
(assert (and (or (and (= l1 l2)) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)))) )
