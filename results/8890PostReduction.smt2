...
(assert (and (and (and (= l1 l1)) (and (= l3 l2)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (is-Cons l1))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (= l3 l3)))) )
(assert (and (not (is-Cons l2))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l1 l1)) )
