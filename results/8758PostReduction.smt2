...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l0 l2)) (and (= l2 l1)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)))) )
