...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 l0)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))))) )
