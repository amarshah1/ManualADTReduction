...
(assert (and (= l2 l0)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l0 l2)))) )
