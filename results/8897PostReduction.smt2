...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) )
(assert (and (or (and (= l0 l2)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
