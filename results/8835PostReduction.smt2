...
(assert (and (or (and (= l3 l2)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
