...
(assert (and (or (and (= l2 l1)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
