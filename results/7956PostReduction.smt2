...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)))) )
...
(assert (and (or (and (= l1 l0)) (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
