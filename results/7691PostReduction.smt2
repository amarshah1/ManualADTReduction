...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (= l0 l1)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)))) )
