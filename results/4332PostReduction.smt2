...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))))) )
