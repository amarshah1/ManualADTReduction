...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l3)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (not (is-Cons l2))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 l1)) (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
