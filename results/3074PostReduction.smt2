...
(assert (and (= l3 l1)) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)))) )
