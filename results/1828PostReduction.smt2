...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 l1)))) )
