...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)) (and (= l1 l0)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (is-Cons l3))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l3 l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l2)) (and (= l0 l1)))) )
