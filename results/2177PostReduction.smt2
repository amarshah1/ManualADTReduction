...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)))) )
...
(assert (and (and (and (= l0 l1)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
