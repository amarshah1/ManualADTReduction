...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l3)))) )
...
(assert (and (and (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
