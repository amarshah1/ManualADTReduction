...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l2 l0)) (and (= l3 l2)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (or (and (= l0 l3)) (and (= l3 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
