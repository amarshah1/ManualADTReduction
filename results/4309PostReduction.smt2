...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l0 l1)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l3 l3)) (and (= l0 l0)))) )
