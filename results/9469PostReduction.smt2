...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l1 l3)) (and (= l1 l1)) (and (= l0 l0)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 l2)) (and (= l0 l3)))) )
