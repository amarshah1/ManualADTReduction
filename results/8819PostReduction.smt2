...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l3)))) )
