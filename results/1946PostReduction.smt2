...
(assert (and (or (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l1 l3)) (and (= l3 l2)) (and (= l0 l3)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 l2)))) )
