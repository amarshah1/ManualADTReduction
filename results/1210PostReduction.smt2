...
(assert (and (and (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l0 l3)) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (= l0 l3)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
