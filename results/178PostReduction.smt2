...
(assert (and (or (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l3 l1)) (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
