...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l2)) (and (= l0 l2)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
(assert (and (or (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons l3))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l3 l3)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)))) )
