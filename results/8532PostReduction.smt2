...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)))) )
...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l3)))) )
(assert (and (not (is-Cons l3))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
