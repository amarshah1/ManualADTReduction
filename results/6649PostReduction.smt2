...
(assert (and (and (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l1 l3)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
