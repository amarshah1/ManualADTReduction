...
(assert (and (or (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (is-Cons l2))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
