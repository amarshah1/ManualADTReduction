...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (= l3 l0)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)) (and (= l0 l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)))) )
