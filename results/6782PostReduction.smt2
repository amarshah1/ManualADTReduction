...
(assert (and (= l0 l1)) )
(assert (and (and (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (or (and (= l3 l2)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)))) )
