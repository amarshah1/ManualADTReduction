...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l0)))) )
