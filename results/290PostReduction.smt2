...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)) (and (= l1 l0)) (and (= l0 l2)))) )
...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 l0)))) )
