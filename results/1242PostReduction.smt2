...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l3 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l1)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l3 l0)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l0)))) )
