...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Nil l3))) )
(assert (and (and (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l3 l3)))) )
(assert (and (and (and (= l1 l3)) (and (= l3 l0)) (and (= l3 l3)) (and (= l3 l0)))) )
