...
(assert (and (or (and (= l1 l3)) (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
