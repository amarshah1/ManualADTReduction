...
(assert (and (and (and (= l3 l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
