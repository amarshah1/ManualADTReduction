...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons l2))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)))) )
