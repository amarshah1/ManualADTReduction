...
(assert (and (and (and (= l1 l0)) (and (= l3 l0)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 l1)))) )
...
(assert (and (or (and (= l0 l1)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
