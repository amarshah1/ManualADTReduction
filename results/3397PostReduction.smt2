...
(assert (and (or (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
