...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (or (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))))) )
(assert (and (is-Cons l2) (= l2 (Cons cv12 cv13)) (= cv12 (Head l2)) (= cv13 (Tail l2))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Nil l2))) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv14 cv15)) (= cv14 (Head l0)) (= cv15 (Tail l0))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv16 cv17)) (= cv16 (Head l3)) (= cv17 (Tail l3))) )
