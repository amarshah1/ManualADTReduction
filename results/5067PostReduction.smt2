...
(assert (and (and (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (not (= l3 l3))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l0 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
