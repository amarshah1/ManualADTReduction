...
(assert (and (and (and (= l3 l1)) (and (= l3 l1)) (and (= l0 l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l1 l1)))) )
