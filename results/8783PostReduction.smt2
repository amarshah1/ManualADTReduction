...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 l0)) (and (= l2 l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (not (= l0 l2))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l0 l0)) (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)))) )
