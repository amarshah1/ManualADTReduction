...
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l3 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l1)))) )
(assert (and (= l2 l2)) )
