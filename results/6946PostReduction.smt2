...
(assert (and (= l1 l2)) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l3 l3)) (and (is-Nil l3) (= l3 Nil)))) )
...
(assert (and (and (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
