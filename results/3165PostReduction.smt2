...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 l3)) (and (= l1 l3)))) )
