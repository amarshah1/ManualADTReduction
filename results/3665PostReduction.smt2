...
(assert (and (or (and (= l2 l2)) (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l2 l0))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)))) )
