...
(assert (and (= l3 l2)) )
(assert (and (or (and (= l0 l0)) (and (= l1 l2)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (= l2 l1)) )
