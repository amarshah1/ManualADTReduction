...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (is-Nil l0) (= l0 Nil)))) )
