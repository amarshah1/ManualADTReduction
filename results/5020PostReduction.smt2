...
(assert (and (or (and (= l0 l2)) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 l2)) )
...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
