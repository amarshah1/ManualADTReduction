...
(assert (and (= l3 l0)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l1 l1)))) )
(assert (and (= l1 l3)) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l3 l0)) )
