...
(assert (and (or (and (= l1 l1)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 l1))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l3 l3)) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)))) )
