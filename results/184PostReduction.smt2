...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 l1)))) )
...
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l0 l3)) )
