...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l2 l0))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
