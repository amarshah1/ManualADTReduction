...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 l2)) )
(assert (and (not (is-Cons l3))) )
(assert (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
