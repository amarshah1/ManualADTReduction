...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l1 l2)) (and (= l2 l3)))) )
...
(assert (and (= l2 l1)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
