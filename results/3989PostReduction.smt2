...
(assert (and (and (and (= l1 l1)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l1)))) )
