...
(assert (and (= l2 l1)) )
(assert (and (and (and (= l3 l1)) (and (= l1 l0)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
