...
(assert (and (or (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
(assert (and (or (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
