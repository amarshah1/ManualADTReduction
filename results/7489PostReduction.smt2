...
(assert (and (and (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
