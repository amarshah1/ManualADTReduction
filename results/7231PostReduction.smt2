...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l1 l3))) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l2 l2)) (and (= l3 l0)))) )
