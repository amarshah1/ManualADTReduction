...
(assert (and (or (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l0 l1)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l0)) (and (= l0 l2)))) )
