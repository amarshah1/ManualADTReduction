...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l1 l2)))) )
