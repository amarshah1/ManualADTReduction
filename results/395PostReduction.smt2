...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l3 l1)) (and (= l1 l1)))) )
