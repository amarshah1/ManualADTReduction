...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 l0))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)))) )
(assert (and (not (= l1 l3))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l3)) (and (= l0 l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l2)))) )
