...
(assert (and (and (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)))) )
