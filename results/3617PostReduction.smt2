...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)))) )
...
(assert (and (or (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)))) )
