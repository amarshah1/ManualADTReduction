...
(assert (and (and (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (or (and (= l1 l1)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)))) )
