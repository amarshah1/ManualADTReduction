...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (not (= l0 Nil))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l3 l1)) (and (= l1 l3)))) )
(assert (and (and (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
