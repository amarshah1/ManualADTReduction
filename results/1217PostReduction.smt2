...
(assert (and (and (and (= l0 l1)) (and (= l1 l2)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
