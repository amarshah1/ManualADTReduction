...
(assert (and (or (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
