...
(assert (and (and (and (= l0 l1)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
