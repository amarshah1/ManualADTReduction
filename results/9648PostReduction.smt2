...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Nil l3) (= l3 Nil)))) )
...
(assert (and (and (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)))) )
