...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l0 l2)))) )
...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)))) )
