...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 l1)) )
(assert (and (not (= l2 l0))) )
(assert (and (or (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l3 l1)) (and (= l1 l1)))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
