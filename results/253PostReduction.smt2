...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l3)))) )
(assert (and (and (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
...
(assert (and (or (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l0) (= l0 Nil)))) )
