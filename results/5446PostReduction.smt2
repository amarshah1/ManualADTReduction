...
(assert (and (or (and (= l2 l1)) (and (= l1 l2)) (and (= l1 l0)) (and (= l0 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l3 l0))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
