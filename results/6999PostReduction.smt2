...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)))) )
...
(assert (and (and (and (= l2 l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
