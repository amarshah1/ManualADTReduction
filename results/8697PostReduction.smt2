...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l2 l1)) (and (= l0 l0)))) )
