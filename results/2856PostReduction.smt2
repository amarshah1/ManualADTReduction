...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (or (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)))) )
