...
(assert (and (or (and (= l1 l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l0 l1))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
(assert (and (= l1 l3)) )
