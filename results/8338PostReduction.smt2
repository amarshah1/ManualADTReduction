...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l0 l2)))) )
(assert (and (not (= l1 l3))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l1 l0)) (and (= l1 l3)) (and (= l0 l1)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)))) )
