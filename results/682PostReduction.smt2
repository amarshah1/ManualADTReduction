...
(assert (and (and (and (= l2 l1)) (and (= l1 l1)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l2 l0)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 l1)) )
