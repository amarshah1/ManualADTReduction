...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l3)) (and (is-Nil l3) (= l3 Nil)))) )
