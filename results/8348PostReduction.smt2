...
(assert (and (or (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
