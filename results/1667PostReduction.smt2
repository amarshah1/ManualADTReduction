...
(assert (and (and (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
