...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l0 l3)) )
(assert (and (and (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
