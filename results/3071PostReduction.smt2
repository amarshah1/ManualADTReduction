...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 l2)) )
(assert (and (or (and (= l2 l0)) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
