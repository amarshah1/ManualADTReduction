...
(assert (and (and (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)))) )
