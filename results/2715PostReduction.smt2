...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))))) )
(assert (and (not (= l2 Nil))) )
