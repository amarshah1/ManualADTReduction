...
(assert (and (and (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)))) )
