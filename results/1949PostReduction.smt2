...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)))) )
...
(assert (and (and (and (= l1 l3)) (and (= l3 l2)))) )
(assert (and (or (and (= l0 l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
