...
(assert (and (= l3 l0)) )
(assert (and (and (and (= l3 l3)) (and (= l3 l1)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
