...
(assert (and (or (and (= l3 l3)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 l0))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
