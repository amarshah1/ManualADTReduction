...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
(assert (and (not (= l0 l3))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
