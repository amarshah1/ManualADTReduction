...
(assert (and (or (and (= l2 l2)) (and (= l2 l0)) (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)))) )
